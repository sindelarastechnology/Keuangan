...
class KasKeluarFactory extends Factory
{
    ...
    {
        $this->afterMaking(function (KasKeluar $model): void {
    ...
    public function definition(): array
    {
        ...
        return [
            'nomor' => 'KK'.date('Ymd').'-'.str_pad($this->faker->unique()->numberBetween(1, 999), 4, '0', STR_PAD_LEFT),
